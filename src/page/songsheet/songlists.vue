...
<template>
  <div>
    ...
    <popup :popup="popup" @hidePopup="hidePopup">
      <div class="all_nav">
        <div class="select_tag">选中分类标签</div>
            ...
            <div v-for="(item,index) in typeNav" :key="index">
              ...
              <el-row>
                <el-col :span="8" v-for="(son,index) in item.list" :key="index">
                  <div @click="selectOne(son)" :class="['tag-one',{'on':son==on}]">{{son}}</div>
                </el-col>
              </el-row>
            </div>
          </div>
        </div>
        <div class="logout">关闭</div>
      </div>
    </popup>
  </div>
</template>
...
import search_nav from "../../components/search-nav";
  ...
  data() {
    return {
      ...
      songItems: [
        {
          imgSrc:
            "http://musicugc.qianqian.com/ugcdiy/pic/41d0dea9a7a988af7b9dae9f0bbf8c07.jpg",
          Playback: "22.9",
          tag: "华语 · 校园 · 思念",
          title: " 听完这首歌，带你回到18岁",
          album_id: "518119881"
        ...
        {
          imgSrc:
            "http://musicugc.cdn.qianqian.com/ugcdiy/pic/18ae11f5ee43f821fbe137b2f8419a41.jpg@w_300,h_300,o_1",
          Playback: "32.2",
          tag: "华语 · 校园 · 寂寞",
          title: "毕业季：转眼就要各奔东西"
        },
        {
          imgSrc:
            "http://hiphotos.qianqian.com/ting/pic/item/b2de9c82d158ccbf7d2d11791ed8bc3eb03541db.jpg",
          Playback: "26.5",
          tag: "流行 · 电子 · 兴奋",
          title: "怀念曾经穿校服的年少轻狂"
        },
        {
          imgSrc:
            "http://hiphotos.qianqian.com/ting/pic/item/b999a9014c086e06fd4f379100087bf40bd1cb01.jpg",
          Playback: "21.8",
          tag: "华语 · 运动 · 流行",
          title: "跑步时必听神曲"
        },
        {
          imgSrc:
            "http://musicugc.cdn.qianqian.com/ugcdiy/pic/a130cf33522e502895f503c3354c8c98.jpg@w_300,h_300,o_1",
          Playback: "11.2",
          tag: "华语 · 影视原声 · ACG",
          title: "动画影视的主题曲真的很好听"
        },
        {
          imgSrc:
            "http://musicugc.cdn.qianqian.com/ugcdiy/pic/0998e8dea0bc37a10d31d76144d8a51b.jpg@w_300,h_300,o_1",
          Playback: "23.5",
          tag: "流行 · 华语 · 旅行",
          title: "旅行伴侣|音乐与你一路随行"
        },
        ...
        {
          imgSrc:
            "http://musicugc.qianqian.com/ugcdiy/pic/87bea95e05d669c95acf12530b67aebd.jpg",
          Playback: "25.7",
          tag: "欧美 · 流行 · 美好",
        ...
        {
          imgSrc:
            "http://musicugc.cdn.qianqian.com/ugcdiy/pic/e5c90a8f58ac9b97c69cb66dba9862d5.jpg@w_300,h_300,o_1",
          Playback: "35.3",
          tag: "华语 · 粤语 · 流行",
          title: "是否风雨带走了你的爱情"
        },
        {
          imgSrc:
            "http://musicugc.cdn.qianqian.com/ugcdiy/pic/ea865aa7f7857d02feac3a10dc806ddc.jpg@w_300,h_300,o_1",
          Playback: "24.3",
          tag: "清新 · 韩语 · 流行",
          title: "每首都有中毒旋律的韩语歌曲"
        },
        {
          imgSrc:
            "http://musicugc.cdn.qianqian.com/ugcdiy/pic/527cc590d584ac444cfc30c2f5479655.jpg@w_300,h_300,o_1",
          Playback: "33.1",
          tag: "华语 · 励志 · 流行",
          title: "永远年轻，永远热泪盈眶"
        }
